...
export interface ForecastDecisionRequest {
  ...
  open_meteo_data?: { marine: unknown; weather: unknown } | null;
}
...
export interface DerivedConditions {
  ...
  swell_incidence: string;
  swell_angle_deg: number | null;
...
export interface DecisionResponse {
  ...
  limitations_ar: string[];
  generated_at: string;
  fisherman_report?: FishermanReport | null;
}

export interface ReportPeriod {
  key: "dawn" | "morning" | "midday" | "dusk";
  label_ar: string;
  range_ar: string;
  state_ar: string;
  ...
  wind_relation_ar: string;
  wind_cast_effect_m: number;
  wave_height_m: number | null;
  wave_period_s: number | null;
  cast_distance_m: number | null;
...
export interface AstronomicalTime {
  kind: "upper_transit" | "lower_transit" | "moonrise" | "moonset" | "high_tide" | "low_tide";
  label_ar: string;
  time_ar: string;
  note_ar: string;
}
...
export interface FishermanReport {
  ...
  opportunity_score: number;
  opportunity_note_ar: string;
  target_bait_ar: string;
  bait_note_ar: string;
  beach_direction_deg: number | null;
  beach_direction_ar: string;
  sunrise_ar: string | null;
  sunset_ar: string | null;
  moonrise_ar: string | null;
  moonset_ar: string | null;
  moon_illumination_pct: number | null;
  moon_upper_transit_ar: string | null;
  moon_lower_transit_ar: string | null;
  tide_high_ar: string[];
  tide_low_ar: string[];
  tide_note_ar: string;
  pressure_hpa: number | null;
  pressure_trend_ar: string;
  beach_summary_ar: string;
  astronomical_times: AstronomicalTime[];
  astronomy_note_ar: string;
  periods: ReportPeriod[];
  red_factors_ar: string[];
  green_factors_ar: string[];
  lead_advice_ar: string;
  timing_advice_ar: string;
  distance_advice_ar: string;
  safety_advice_ar: string;
  water_temp_c: number | null;
  air_temp_c: number | null;
  max_gust_kmh: number | null;
  reference_note_ar: string;
}
